        ...
        <>
            <div className="sidenav padding--small col-height-10">
                <div className="sidenav-group align-top">
                    ...
                    <br/><br/>
                    <a href="/courses" className="no-decoration"><p className="sidenav-item text--light">File Name</p></a>
                    <a href="/dashboard" className="no-decoration text--light"><p className="sidenav-item">File Name</p></a>
